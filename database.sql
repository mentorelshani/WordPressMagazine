...
INSERT INTO `articles_categories` VALUES (1,6,2),(2,6,6),(3,7,2),(5,6,5),(7,8,6),(8,1,6),(9,8,3),(10,6,5),(11,7,5),(12,25,1),(13,25,2),(14,25,4),(15,26,1),(16,26,2),(17,26,4);
...
INSERT INTO `comments` VALUES (12,'MENTOR',4,'Nice','2018-10-10 00:00:00'),(13,'User1',3,'comment1','2018-10-10 00:00:00'),(15,'User2',3,'comment3','2018-10-10 00:00:00'),(16,'Mentor',5,'comment','2018-10-10 00:00:00'),(17,'User1',7,'comment','2018-10-10 00:00:00'),(18,'User1',8,'comment1','2018-10-10 00:00:00'),(19,'MENTOR',3,'comment2','2018-10-10 00:00:00'),(20,'User2',3,'comment3','2018-10-10 00:00:00'),(21,'Mentor',7,'comment','2018-10-10 00:00:00'),(22,'User1',3,'comment','2018-10-10 00:00:00'),(24,'User1',6,'comment1','2018-10-10 00:00:00'),(25,'MENTOR',7,'comment2','2018-10-10 00:00:00'),(26,'User2',4,'comment3','2018-10-10 00:00:00'),(27,'Mentor',4,'comment','2018-10-10 00:00:00'),(28,'User1',6,'comment','2018-10-10 00:00:00'),(29,'User1',4,'comment1','2018-10-10 00:00:00'),(30,'MENTOR',1,'comment2','2018-10-10 00:00:00'),(31,'User2',1,'comment3','2018-10-10 00:00:00'),(32,'Mentor',7,'comment','2018-10-10 00:00:00'),(36,'MENTOR',3,'comment2','2018-10-10 00:00:00'),(37,'User2',3,'comment3','2018-10-10 00:00:00'),(38,'Mentor',4,'comment','2018-10-10 00:00:00'),(39,'User1',4,'comment','2018-10-10 00:00:00'),(40,'User1',6,'comment1','2018-10-10 00:00:00'),(41,'MENTOR',5,'comment2','2018-10-10 00:00:00'),(42,'User2',4,'comment3','2018-10-10 00:00:00'),(43,'Mentor',5,'comment','2018-10-10 00:00:00'),(44,'User1',4,'comment','2018-10-10 00:00:00');
...
INSERT INTO `users` VALUES (1,'mentor','men@asd.com','123das','$argon2i$v=19$m=1024,t=2,p=2$WFhUUFIucy5razU5b1E3Vg$GqIRHQkWdq8SLnttpKgl5W3KnllHM/YQQt5flBSWBUk','2015-10-10 00:00:00','Admin'),(2,'mentor','men@asd.com','123das','$argon2i$v=19$m=1024,t=2,p=2$WFhUUFIucy5razU5b1E3Vg$GqIRHQkWdq8SLnttpKgl5W3KnllHM/YQQt5flBSWBUk','2015-10-10 00:00:00','Admin'),(3,'mentori','men1@asd.com','123das','$argon2i$v=19$m=1024,t=2,p=2$WFhUUFIucy5razU5b1E3Vg$GqIRHQkWdq8SLnttpKgl5W3KnllHM/YQQt5flBSWBUk','2015-10-10 00:00:00','Admin');
...
/*!50001 VIEW `v_articles` AS select `a`.`id` AS `id`,`a`.`user_id` AS `user_id`,`a`.`title` AS `title`,`a`.`body` AS `body`,`a`.`img` AS `img`,`a`.`created_at` AS `created_at`,(select count(0) from `comments` where (`comments`.`article_id` = `a`.`id`)) AS `comments` from `articles` `a` */;
...
-- Dump completed on 2018-06-02 21:03:42
